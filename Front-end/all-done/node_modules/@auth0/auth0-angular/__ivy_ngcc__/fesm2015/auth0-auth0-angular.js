import { InjectionToken, ɵɵdefineInjectable, ɵɵinject, INJECTOR, Injectable, Injector, Optional, Inject, NgModule } from '@angular/core';
import { Auth0Client } from '@auth0/auth0-spa-js';
import { BehaviorSubject, ReplaySubject, Subject, merge, defer, of, iif, from, throwError } from 'rxjs';
import { scan, filter, distinctUntilChanged, switchMap, mergeMap, concatMap, catchError, tap, takeUntil, map, take, pluck, first } from 'rxjs/operators';
...
AuthClientConfig.ɵprov = ɵɵdefineInjectable({ factory: function AuthClientConfig_Factory() { return new AuthClientConfig(ɵɵinject(AuthConfigService, 8)); }, token: AuthClientConfig, providedIn: "root" });
...
AuthService.ɵprov = ɵɵdefineInjectable({ factory: function AuthService_Factory() { return new AuthService(ɵɵinject(Auth0ClientService), ɵɵinject(AuthClientConfig), ɵɵinject(Location), ɵɵinject(AbstractNavigator)); }, token: AuthService, providedIn: "root" });
...
export { AuthClientConfig, AuthConfigService, AuthGuard, AuthHttpInterceptor, AuthModule, AuthService, isHttpInterceptorRouteConfig, Auth0ClientFactory as ɵa, Auth0ClientService as ɵb, AbstractNavigator as ɵc };
