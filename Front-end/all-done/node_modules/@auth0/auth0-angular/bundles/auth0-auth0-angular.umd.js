(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('@auth0/auth0-spa-js'),exports, require('@angular/core'), require('@auth0/auth0-spa-js'), require('rxjs'), require('rxjs/operators'), require('@angular/router'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@auth0/auth0-angular', ['@angular/core','@angular/common','@auth0/auth0-spa-js','exports', '@angular/core', '@auth0/auth0-spa-js', 'rxjs', 'rxjs/operators', '@angular/router', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.common,global.auth0.auth0SpaJs,(global.auth0 = global.auth0 || {}, global.auth0['auth0-angular'] = {}), global.ng.core, global.auth0SpaJs, global.rxjs, global.rxjs.operators, global.ng.router, global.ng.common));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, i0, auth0SpaJs, rxjs, operators, router, i1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var useragent = { name: '@auth0/auth0-angular', version: '1.4.1' };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AuthClientConfig, [{
    ...
    var AuthService = /** @class */ (function () {
        function AuthService(auth0Client, configFactory, location, navigator) {
            ...
            }, { current: null, previous: null }), operators.filter(function (_c) {
                var previous = _c.previous, current = _c.current;
            ...
            this.isAuthenticatedTrigger$ = this.isLoading$.pipe(operators.filter(function (loading) { return !loading; }), operators.distinctUntilChanged(), operators.switchMap(function () {
                ...
                return rxjs.merge(rxjs.defer(function () { return _this.auth0Client.isAuthenticated(); }), _this.accessTokenTrigger$.pipe(operators.mergeMap(function () { return _this.auth0Client.isAuthenticated(); })), _this.refreshState$.pipe(operators.mergeMap(function () { return _this.auth0Client.isAuthenticated(); })));
            }));
            /**
             * Emits boolean values indicating the authentication state of the user. If `true`, it means a user has authenticated.
             * This depends on the value of `isLoading$`, so there is no need to manually check the loading state of the SDK.
             */
            this.isAuthenticated$ = this.isAuthenticatedTrigger$.pipe(operators.distinctUntilChanged());
            /**
        ...
        AuthService.prototype.getAccessTokenSilently = function (options) {
            var _this = this;
            return rxjs.of(this.auth0Client).pipe(operators.concatMap(function (client) { return client.getTokenSilently(options); }), operators.tap(function (token) { return _this.accessToken$.next(token); }), operators.catchError(function (error) {
                _this.errorSubject$.next(error);
                _this.refreshState$.next();
        ...
        AuthService.prototype.getAccessTokenWithPopup = function (options) {
            var _this = this;
            return rxjs.of(this.auth0Client).pipe(operators.concatMap(function (client) { return client.getTokenWithPopup(options); }), operators.tap(function (token) { return _this.accessToken$.next(token); }), operators.catchError(function (error) {
                _this.errorSubject$.next(error);
                _this.refreshState$.next();
                return rxjs.throwError(error);
            }));
        ...
        AuthService.prototype.shouldHandleCallback = function () {
            var _this = this;
            return rxjs.of(this.location.path()).pipe(operators.map(function (search) {
...
AuthService.ɵfac = function AuthService_Factory(t) { return new (t || AuthService)(ɵngcc0.ɵɵinject(Auth0ClientService), ɵngcc0.ɵɵinject(AuthClientConfig), ɵngcc0.ɵɵinject(ɵngcc1.Location), ɵngcc0.ɵɵinject(AbstractNavigator)); };
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AuthService, [{
        ...
        args: [{
            ...
            }] }, { type: AuthClientConfig }, { type: ɵngcc1.Location }, { type: AbstractNavigator }]; }, null); })();
        return AuthService;
    }());
    AuthService.ɵprov = i0.ɵɵdefineInjectable({ factory: function AuthService_Factory() { return new AuthService(i0.ɵɵinject(Auth0ClientService), i0.ɵɵinject(AuthClientConfig), i0.ɵɵinject(i1.Location), i0.ɵɵinject(AbstractNavigator)); }, token: AuthService, providedIn: "root" });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AuthModule, [{
    ...
    var AuthHttpInterceptor = /** @class */ (function () {
        ...
        AuthHttpInterceptor.prototype.intercept = function (req, next) {
            ...
            // outgoing request
            rxjs.of(route).pipe(operators.pluck('tokenOptions'), operators.concatMap(function (options) { return _this.authService.getAccessTokenSilently(options).pipe(operators.catchError(function (err) {
...
AuthHttpInterceptor.ɵfac = function AuthHttpInterceptor_Factory(t) { return new (t || AuthHttpInterceptor)(ɵngcc0.ɵɵinject(AuthClientConfig), ɵngcc0.ɵɵinject(AuthService)); };
AuthHttpInterceptor.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: AuthHttpInterceptor, factory: function (t) { return AuthHttpInterceptor.ɵfac(t); } });
